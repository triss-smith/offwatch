/**
 * `@offwatch/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@offwatch/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@offwatch/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@offwatch/plugin-sdk/ui";
 *
