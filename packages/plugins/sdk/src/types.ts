 ...
 * from `@offwatch/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @offwatch/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
 ...
 * ```
 *
 * @see usePluginStream in `@offwatch/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@offwatch/plugin-sdk";
 *
