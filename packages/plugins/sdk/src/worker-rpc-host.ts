...
import type { PaperclipPluginManifestV1 } from "@offwatch/shared";
 ...
 * import { startWorkerRpcHost } from "@offwatch/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@offwatch/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
