...
export default defineConfig({
  ...
  // The webServer directive starts `offwatch run` before tests.
  // Expects `pnpm offwatch` to be runnable from repo root.
  webServer: {
    command: `pnpm offwatch run`,
    ...
    env: {
      ...process.env,
      PORT: String(PORT),
      OFFWATCH_DEPLOYMENT_MODE: "local_trusted",
    },
  },
