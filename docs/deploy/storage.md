...
Offwatch stores uploaded files (issue attachments, images) using a configurable storage provider.
...
```
~/.offwatch/instances/default/data/storage
```
...
```
~/.offwatch/instances/default/config.json
```
