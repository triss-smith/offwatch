...
Manage companies within your Offwatch instance.
...
Company logo uploads use the normal Offwatch attachment size limit.
...
| `logoUrl` | string | Optional Offwatch asset content path for the stored logo image |
