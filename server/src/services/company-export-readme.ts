...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Offwatch](https://offwatch.ing)");
  lines.push("");
  ...
  lines.push("");
  lines.push("```bash");
  lines.push("pnpm offwatchai company import this-github-url-or-folder");
  lines.push("```");
  lines.push("");
  lines.push("See [Offwatch](https://offwatch.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Offwatch](https://offwatch.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
