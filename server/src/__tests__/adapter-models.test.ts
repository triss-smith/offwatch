...
import { models as codexFallbackModels } from "@offwatch/adapter-codex-local";
import { models as cursorFallbackModels } from "@offwatch/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@offwatch/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@offwatch/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.OFFWATCH_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.OFFWATCH_OPENCODE_COMMAND = "__offwatch_missing_opencode_command__";
