...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://offwatch:offwatch@127.0.0.1:5432/offwatch",
    embeddedPostgresDataDir: "/tmp/offwatch-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/offwatch-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/offwatch-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/offwatch-storage",
    storageS3Bucket: "offwatch-test",
