 ...
 *
 * Plugin bundles are built with `external: ["@offwatch/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@offwatch/plugin-sdk/ui";
 ...
 * - `import { ... } from "@offwatch/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@offwatch/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@offwatch/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@offwatch/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@offwatch/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@offwatch/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
