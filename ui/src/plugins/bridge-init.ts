 ...
 *
 * This is placed on `globalThis.__offwatchPluginBridge__` and consumed by
...
declare global {
  ...
  var __offwatchPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__offwatchPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__offwatchPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
