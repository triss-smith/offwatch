...
import { AGENT_ROLE_LABELS } from "@offwatch/shared";
...
export const help: Record<string, string> = {
  ...
  cwd: "The directory the agent runs in. Set this to make the agent work on a specific codebase or project folder (e.g. /home/user/myapp). Leave blank to use the process default.",
  ...
  workspaceStrategy: "How Offwatch should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when Offwatch starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Offwatch adds its standard wake and workspace fields.",
