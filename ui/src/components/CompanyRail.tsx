...
import { Offwatch, Plus } from "lucide-react";
...
const ORDER_STORAGE_KEY = "offwatch.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Offwatch icon - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <Offwatch className="h-5 w-5 text-foreground" />
      </div>
