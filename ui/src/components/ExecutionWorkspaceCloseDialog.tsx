...
import type { ExecutionWorkspace } from "@offwatch/shared";
      ...
      <DialogContent className="max-h-[85vh] overflow-x-hidden overflow-y-auto p-4 sm:max-w-2xl sm:p-6 [&>*]:min-w-0">
        <DialogHeader>
          ...
          <DialogDescription className="break-words text-xs sm:text-sm">
            ...
            artifacts. Offwatch keeps the workspace record and issue history, but removes it from active workspace views.
          </DialogDescription>
        </DialogHeader>
