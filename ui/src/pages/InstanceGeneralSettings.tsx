...
import type { PatchInstanceGeneralSettings, BackupRetentionPolicy } from "@offwatch/shared";
import {
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              ...
              Offwatch Labs. Votes are always saved locally.
            </p>
            {FEEDBACK_TERMS_URL ? (
              <a
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Sign out of this Offwatch instance. You will be redirected to the login page.
            </p>
          </div>
          <Button
            variant="outline"
