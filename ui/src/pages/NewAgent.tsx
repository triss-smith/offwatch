...
import { AGENT_ROLES } from "@offwatch/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("offwatchai/offwatch/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Offwatch runtime skills are added automatically.
              </p>
            </div>
