...
description: >
  Create new agents in Offwatch with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# Offwatch Create Agent Skill
...
2. Discover available adapter configuration docs for this Offwatch instance.
...
- if the role needs skills, make sure they already exist in the company library or install them first using the Offwatch company-skills workflow
...
`skills/offwatch-create-agent/references/api-reference.md`
